                ...
                <div className="container px-4">
                    ...
                    <div className="collapse navbar-collapse" id="navbarResponsive">
                        <ul className="navbar-nav ms-auto">
                            <li className="nav-item"><a id='link-inicio' className="nav-link active" href="#inicio" onClick={() => {setNavLinkActive(document.getElementById("link-inicio"))}}>Inicio</a></li>
                            <li className="nav-item"><a id='link-anuncios' className="nav-link" href="#anuncios" onClick={() => {setNavLinkActive(document.getElementById("link-anuncios"))}}>Compra/vende equipo</a></li>
