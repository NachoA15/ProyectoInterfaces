    ...
    return (
        ...
        <div id='inicio'>
            <div className='textLeft'>
                ...
                <br/>
                <p className='parrafo'>Desde comprar el material que buscas o vender el tuyo propio 
        ...
        <div id='anuncios'>
            <div className='textRight'>
                ...
                <br/>
                <p className='parrafo'>Busca y compra equipo que te interese de otros usuarios a través de los anuncios.
                    ¡Tu también puedes vender el tuyo!</p>
                <br/>
                <p className='parrafo'>Busca según diferentes filtros y añade los anuncios que te llamen la atención a 
        ...
        <div id='interactua'>
            <div className='textLeft'>
                ...
                <br/>
                <p className='parrafo'>Comenta en los anuncios y participa en discusiones sobre instrumentos, equipo, 
                    experiencias personales... </p>
                <p className='parrafo'>Personaliza tu perfil con cualquier cosa sobre ti que quieras
                    compartir con el resto. También puedes visitar el perfil de otros usuarios.</p>
                <p className='parrafo'>¡Conecta con gente que comparte tu misma pasión!</p>
            </div>
        </div>
        <div id='sobre-nosotros'>
            <div className='textRight'>
                ...
                <br/>
                <p className='parrafo'>Somos un equipo de estudiantes de Ingeniería de Software de la Universidad de Málaga
